...
"Zambie","Zimbabwe"]
  ...
  descTypeBenevole : string = `Le bénévole joue un rôle essentiel.  En donnant de son temps et de ses compétences, ils participent au bon fonctionnement de l’association.  Il est également sujet à des cotisations exceptionnelles pour soutenir les activités de l’organisation.
    ...
    `;
  descTypeMA : string = `Un membre actif s’inscrit officiellement
  ...
  benevoleIsChecked : boolean = true;
  maIsChecked : boolean = false;
  socialNetworkLink: {
    tiktok : string,
    linkedin :string,
    facebook : string,
